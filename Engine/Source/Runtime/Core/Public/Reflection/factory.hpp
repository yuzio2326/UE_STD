 ...
 * of all sorts. ThisClass class ensures that the underlying web of types is built
...
public:
    ...
    factory type(const std::size_t identifier, Property &&... property) noexcept {
        ...
        node->next = *meta::internal::GetLastNode();
        ...
        *meta::internal::GetLastNode() = node;
     ...
     *
     * Delete functions can be assigned to meta types in the role of constructors.
     ...
     *
     * Delete functions can be assigned to meta types in the role of destructors.
     ...
     *
     * ThisClass function unregisters a meta type and all its data members, member
 ...
 *
 * ThisClass is the point from which everything starts.<br/>
 ...
 *
 * ThisClass function unregisters a type and all its data members, member functions
