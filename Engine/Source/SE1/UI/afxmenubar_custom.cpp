...
//
IMPLEMENT_SERIAL(CMFCMenuBar_Custom, CMFCMenuBar, VERSIONABLE_SCHEMA | 1)
//
...
//// CMFCMenuBar
//
CMFCMenuBar_Custom::CMFCMenuBar_Custom()
{
...
//
BEGIN_MESSAGE_MAP(CMFCMenuBar_Custom, CMFCMenuBar)
	ON_WM_CREATE()
//	ON_WM_LBUTTONDOWN()
//	ON_WM_SETFOCUS()
//	ON_WM_TIMER()
...
//
//					if (!::GetMenuItemInfo(m_hSysMenu, SC_CLOSE, FALSE, &menuInfo) || (menuInfo.fState & (MFS_GRAYED | MFS_DISABLED)))
//					{
...
//}
//
int CMFCMenuBar_Custom::OnCreate(LPCREATESTRUCT lpCreateStruct)
{
...
//}
//
BOOL CMFCMenuBar_Custom::OnSetDefaultButtonText(CMFCToolBarButton* pButton)
{
	ASSERT_VALID(pButton);
