...
class CMFCMenuBar_Custom : public CMFCMenuBar
{
	...
	DECLARE_SERIAL(CMFCMenuBar_Custom)
...
//	}
//
	virtual BOOL OnSetDefaultButtonText(CMFCToolBarButton* pButton) override;
